...
import CtCILibrary.CtCILibrary.HashMapList;
...
public class QuestionC {
	...
	public static CtCILibrary.CtCILibrary.HashMapList<String, String> initializeDictionary(String[] words) {
		...
		CtCILibrary.CtCILibrary.HashMapList<String, String> wordsToNumbers = new HashMapList<String, String>(); 
	...
	public static void main(String[] args) {
		CtCILibrary.CtCILibrary.HashMapList<String, String> dictionary = initializeDictionary(AssortedMethods.getListOfWords());
